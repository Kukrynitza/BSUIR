  ...
  return (
    <div className="panel">
      ...
      <div className="help-content">
        ...
        <h3>Инструкция</h3>
        <ol>
          <li>Введите текст в поле «Анализ текста» или загрузите файл (TXT, RTF, DOCX)</li>
          ...
          <li>На вкладке «Деревья» доступны зависимости, составление и семантика по введённому тексту; для загруженного документа — семантические роли, связи и экспорт JSON</li>
