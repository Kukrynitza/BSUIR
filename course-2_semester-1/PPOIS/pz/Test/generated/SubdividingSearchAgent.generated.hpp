...
#define SubdividingSearchAgent_hpp_20_init  bool _InitInternal(ScAddr const & outputStructure = ScAddr::Empty) override \
{ \
...
#define SubdividingSearchAgent_hpp_20_initStatic static bool _InitStaticInternal(ScAddr const & outputStructure = ScAddr::Empty)  \
{ \
