...
На десяти проверочных фразах все три способа ответили правильно. На длинном документе заметно быстрее метод частотных слов: ему не нужно просматривать весь текст.
