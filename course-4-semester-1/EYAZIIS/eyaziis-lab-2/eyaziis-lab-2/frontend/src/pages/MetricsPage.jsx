  ...
  return (
    <>
      <div className="card">
        ...
        <p className="muted">
          Оценка выполняется на эталонных текстах с заранее известным языком. Для каждого текста
          система запускает три метода и считает точность, полноту, F-меру и время работы.
        </p>
